 ...
 * ended up pointing at a podcast. Comparing the exact title doesn't work either (releases are
 * named `Titulo.2022.1080p-dual-lat`); a model comparing is the only thing that covers both cases.
 */
