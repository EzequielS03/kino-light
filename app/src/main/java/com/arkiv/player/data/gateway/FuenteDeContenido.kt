 ...
 * cliente directo del portal no las toca (implementación única hoy: `MagisFuente`). Los modelos
 * siguen llamándose `Gateway*` porque renombrarlos sería churn sin ninguna ganancia (son el
 * contrato, no el transporte).
 *
