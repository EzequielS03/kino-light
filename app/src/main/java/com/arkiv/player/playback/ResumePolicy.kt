...
object ResumePolicy {
     ...
     *
     * A propósito NO consulta el estado de la descarga. Antes, para torrents, se descartaba la
     * posición si esa zona no estaba bajada — y como en un magnet recién abierto nunca lo está, el
     * torrent arrancaba SIEMPRE desde el principio. Ahora se respeta: el servidor de streaming ancla
     * la descarga secuencial en el punto pedido (`setSequentialRange`) apenas el player pide ese
     * rango, así que las piezas que hacen falta se priorizan solas.
     */
