...
class TvKeyboardTest {
    ...
    // --- Task 9: extended keyboard (lowercase + symbols) for the TV's login. The search keyboard
    // still uses TV_KEYBOARD_ROWS/applyKey as-is -the tests above didn't change-; these test the
    // new addition without touching that contract.
